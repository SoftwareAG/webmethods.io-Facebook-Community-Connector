module.exports = {
  ...
  name: "create_a_new_album_on_a_page",

  title: "Create A New Album On A Page",
...
comment:{
 ...
 var x="https://graph.facebook.com/"+input.auth.page_id+"/albums?name="+input.comment+"&access_token="+ input.auth.page_access_token;
