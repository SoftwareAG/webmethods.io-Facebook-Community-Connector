module.exports = {
  ...
  name: "publish_a_post_on_a_page",

  title: "Publish A Post On A Page",
 ...
 var x="https://graph.facebook.com/"+input.auth.page_id+"/feed?message="+input.comment+"&access_token="+ input.auth.page_access_token;
